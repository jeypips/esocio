...
>>>>>>> refs/remotes/origin/jp
			...
			doc.text(40, 210, 'Grassland/Shrubland Areas:' +profile_sectors.environmental.parameters[0].items[1].item_value);
			doc.text(40, 215, 'Forest/Wooded Areas:' +profile_sectors.environmental.parameters[0].items[2].item_value);
			doc.text(120, 205, 'Bareland Areas:' +profile_sectors.environmental.parameters[0].items[3].item_value);
			doc.text(120, 210, 'Wetland Areas:' +profile_sectors.environmental.parameters[0].items[4].item_value);
			doc.text(120, 215, 'Built-up Areas:' +profile_sectors.environmental.parameters[0].items[5].item_value);
			doc.setFontType('bold');
			doc.text(20, 225, 'Land Classification');
			doc.setFontType('normal');
			doc.text(40, 230, 'Certified A & D:' +profile_sectors.environmental.parameters[1].items[0].item_value);
			doc.text(40, 235, 'Public Forest Land:' +profile_sectors.environmental.parameters[1].items[1].item_value);
			...
			doc.text(20, 245, 'Length of RIVERBANKS:' +profile_sectors.environmental.parameters[1].items[9].item_value);
...
<<<<<<< HEAD
			...
			doc.setFontType('normal');
			doc.text(50, 115, 'Concrete:'+profile_sectors.infra.parameters[0].items[0].group_items[0].item_group_value);
			doc.text(80, 115, 'Asphalt:'+profile_sectors.infra.parameters[0].items[0].group_items[1].item_group_value);
			doc.text(110, 115, 'Gravel:'+profile_sectors.infra.parameters[0].items[0].group_items[2].item_group_value);
			doc.text(140, 115, 'Earthfill:'+profile_sectors.infra.parameters[0].items[0].group_items[3].item_group_value);
			doc.setFontType('bold');
			doc.text(40, 120, 'Municipal Road');
			doc.setFontType('normal');
			doc.text(50, 125, 'Concrete:'+profile_sectors.infra.parameters[0].items[1].group_items[0].item_group_value);
			doc.text(80, 125, 'Asphalt:'+profile_sectors.infra.parameters[0].items[1].group_items[1].item_group_value);
			doc.text(110, 125, 'Gravel:'+profile_sectors.infra.parameters[0].items[1].group_items[2].item_group_value);
			doc.text(140, 125, 'Earthfill:'+profile_sectors.infra.parameters[0].items[1].group_items[3].item_group_value);
			doc.setFontType('bold');
			doc.text(40, 130, 'Provincial Road');
			doc.setFontType('normal');
			doc.text(50, 135, 'Concrete:'+profile_sectors.infra.parameters[0].items[2].group_items[0].item_group_value);
			doc.text(80, 135, 'Asphalt:'+profile_sectors.infra.parameters[0].items[2].group_items[1].item_group_value);
			doc.text(110, 135, 'Gravel:'+profile_sectors.infra.parameters[0].items[2].group_items[2].item_group_value);
			doc.text(140, 135, 'Earthfill:'+profile_sectors.infra.parameters[0].items[2].group_items[3].item_group_value);
			doc.setFontType('bold');
			doc.text(40, 140, 'National Road');
			doc.setFontType('normal');
			doc.text(50, 145, 'Concrete:'+profile_sectors.infra.parameters[0].items[3].group_items[0].item_group_value);
			doc.text(80, 145, 'Asphalt:'+profile_sectors.infra.parameters[0].items[3].group_items[1].item_group_value);
			doc.text(110, 145, 'Gravel:'+profile_sectors.infra.parameters[0].items[3].group_items[2].item_group_value);
			doc.text(140, 145, 'Earthfill:'+profile_sectors.infra.parameters[0].items[3].group_items[3].item_group_value);
			doc.setFontType('bold');
			doc.text(30, 157, 'Bridges');			
			doc.text(40, 162, 'Barangay Bridges');
			doc.text(50, 167, '(Total Number of Span)');
			doc.setFontType('normal');
			doc.text(50, 172, 'Steel:'+profile_sectors.infra.parameters[1].items[0].group_items[0].item_group_value);
			doc.text(65, 172, 'Concrete:'+profile_sectors.infra.parameters[1].items[0].group_items[1].item_group_value);
			doc.text(90, 172, 'Composite:'+profile_sectors.infra.parameters[1].items[0].group_items[2].item_group_value);
			doc.text(115, 172, 'Jumbo:'+profile_sectors.infra.parameters[1].items[0].group_items[3].item_group_value);
			doc.text(135, 172, 'Bailey:'+profile_sectors.infra.parameters[1].items[0].group_items[4].item_group_value);
			doc.text(155, 172, 'Footbridge:'+profile_sectors.infra.parameters[1].items[0].group_items[5].item_group_value);
			doc.setFontType('bold');
			doc.text(50, 177, '(Total Length)');
			doc.setFontType('normal');
			doc.text(50, 182, 'Steel:'+profile_sectors.infra.parameters[1].items[1].group_items[0].item_group_value);
			doc.text(65, 182, 'Concrete:'+profile_sectors.infra.parameters[1].items[1].group_items[1].item_group_value);
			doc.text(90, 182, 'Composite:'+profile_sectors.infra.parameters[1].items[1].group_items[2].item_group_value);
			doc.text(115, 182, 'Jumbo:'+profile_sectors.infra.parameters[1].items[1].group_items[3].item_group_value);
			doc.text(135, 182, 'Bailey:'+profile_sectors.infra.parameters[1].items[1].group_items[4].item_group_value);
			doc.text(155, 182, 'Footbridge:'+profile_sectors.infra.parameters[1].items[1].group_items[5].item_group_value);
			doc.setFontType('bold');
			doc.text(40, 187, 'Municipal Bridges');
			doc.text(50, 192, '(Total Number of Span)');
			doc.setFontType('normal');
			doc.text(50, 196, 'Steel:'+profile_sectors.infra.parameters[1].items[2].group_items[0].item_group_value);
			doc.text(65, 196, 'Concrete:'+profile_sectors.infra.parameters[1].items[2].group_items[1].item_group_value);
			doc.text(90, 196, 'Composite:'+profile_sectors.infra.parameters[1].items[2].group_items[2].item_group_value);
			doc.text(115, 196, 'Jumbo:'+profile_sectors.infra.parameters[1].items[2].group_items[3].item_group_value);
			doc.text(135, 196, 'Bailey:'+profile_sectors.infra.parameters[1].items[2].group_items[4].item_group_value);
			doc.text(155, 196, 'Footbridge:'+profile_sectors.infra.parameters[1].items[2].group_items[5].item_group_value);
			doc.setFontType('bold');
			doc.text(50, 200, '(Total Length)');
			doc.setFontType('normal');
			doc.text(50, 204, 'Steel:'+profile_sectors.infra.parameters[1].items[3].group_items[0].item_group_value);
			doc.text(65, 204, 'Concrete:'+profile_sectors.infra.parameters[1].items[3].group_items[1].item_group_value);
			doc.text(90, 204, 'Composite:'+profile_sectors.infra.parameters[1].items[3].group_items[2].item_group_value);
			doc.text(115, 204, 'Jumbo:'+profile_sectors.infra.parameters[1].items[3].group_items[3].item_group_value);
			doc.text(135, 204, 'Bailey:'+profile_sectors.infra.parameters[1].items[3].group_items[4].item_group_value);
			doc.text(155, 204, 'Footbridge:'+profile_sectors.infra.parameters[1].items[3].group_items[5].item_group_value);
			doc.setFontType('bold');
			doc.text(40, 209, 'Provincial Bridges');
			doc.text(50, 214, '(Total Number of Span)');
			doc.setFontType('normal');
			doc.text(50, 218, 'Steel:'+profile_sectors.infra.parameters[1].items[4].group_items[0].item_group_value);
			doc.text(65, 218, 'Concrete:'+profile_sectors.infra.parameters[1].items[4].group_items[1].item_group_value);
			doc.text(90, 218, 'Composite:'+profile_sectors.infra.parameters[1].items[4].group_items[2].item_group_value);
			doc.text(115, 218, 'Jumbo:'+profile_sectors.infra.parameters[1].items[4].group_items[3].item_group_value);
			doc.text(135, 218, 'Bailey:'+profile_sectors.infra.parameters[1].items[4].group_items[4].item_group_value);
			doc.text(155, 218, 'Footbridge:'+profile_sectors.infra.parameters[1].items[4].group_items[5].item_group_value);
			doc.setFontType('bold');
			doc.text(50, 222, '(Total Length)');
			doc.setFontType('normal');
			doc.text(50, 226, 'Steel:'+profile_sectors.infra.parameters[1].items[5].group_items[0].item_group_value);
			doc.text(65, 226, 'Concrete:'+profile_sectors.infra.parameters[1].items[5].group_items[1].item_group_value);
			doc.text(90, 226, 'Composite:'+profile_sectors.infra.parameters[1].items[5].group_items[2].item_group_value);
			doc.text(115, 226, 'Jumbo:'+profile_sectors.infra.parameters[1].items[5].group_items[3].item_group_value);
			doc.text(135, 226, 'Bailey:'+profile_sectors.infra.parameters[1].items[5].group_items[4].item_group_value);
			doc.text(155, 226, 'Footbridge:'+profile_sectors.infra.parameters[1].items[5].group_items[5].item_group_value);
			doc.setFontType('bold');
			doc.text(40, 231, 'National Bridges');
			doc.text(50, 236, '(Total Number of Span)');
			doc.setFontType('normal');
			doc.text(50, 240, 'Steel:'+profile_sectors.infra.parameters[1].items[6].group_items[0].item_group_value);
			doc.text(65, 240, 'Concrete:'+profile_sectors.infra.parameters[1].items[6].group_items[1].item_group_value);
			doc.text(90, 240, 'Composite:'+profile_sectors.infra.parameters[1].items[6].group_items[2].item_group_value);
			doc.text(115, 240, 'Jumbo:'+profile_sectors.infra.parameters[1].items[6].group_items[3].item_group_value);
			doc.text(135, 240, 'Bailey:'+profile_sectors.infra.parameters[1].items[6].group_items[4].item_group_value);
			doc.text(155, 240, 'Footbridge:'+profile_sectors.infra.parameters[1].items[6].group_items[5].item_group_value);
			doc.setFontType('bold');
			doc.text(50, 244, '(Total Length)');
			doc.setFontType('normal');
			doc.text(50, 248, 'Steel:'+profile_sectors.infra.parameters[1].items[7].group_items[0].item_group_value);
			doc.text(65, 248, 'Concrete:'+profile_sectors.infra.parameters[1].items[7].group_items[1].item_group_value);
			doc.text(90, 248, 'Composite:'+profile_sectors.infra.parameters[1].items[7].group_items[2].item_group_value);
			doc.text(115, 248, 'Jumbo:'+profile_sectors.infra.parameters[1].items[7].group_items[3].item_group_value);
			doc.text(135, 248, 'Bailey:'+profile_sectors.infra.parameters[1].items[7].group_items[4].item_group_value);
			doc.text(155, 248, 'Footbridge:'+profile_sectors.infra.parameters[1].items[7].group_items[5].item_group_value);
			
			doc.addPage();
			doc.setFontType('bold');
			doc.text(20, 45, 'F. SOCIAL WELFARE' );	
			doc.setFontType('normal');
			doc.text(30, 50, 'Number of Day Care Center:'+profile_sectors.social.parameters[0].items[0].item_value);	
			doc.text(30, 54, 'Number of Day Care Worker:'+profile_sectors.social.parameters[0].items[1].item_value);	
			doc.text(30, 58, 'Number of Day Care Children:'+profile_sectors.social.parameters[0].items[2].item_value);	
			doc.setFontType('bold');
			doc.text(20, 68, 'G. HEALTH SECTOR' );	
			doc.setFontType('normal');
			doc.text(30, 73, 'Crude Birth Rate:'+profile_sectors.health.parameters[0].items[0].item_value );
			doc.text(30, 77, 'Crude Death Rate:'+profile_sectors.health.parameters[0].items[1].item_value);
			doc.text(30, 81, 'Maternal Mortality Rate:'+profile_sectors.health.parameters[0].items[2].item_value);
			doc.text(30, 85, 'Infant Mortality Rate:'+profile_sectors.health.parameters[0].items[3].item_value);
			doc.text(30, 89, 'Morbidity Rate:'+profile_sectors.health.parameters[0].items[4].item_value);
			doc.text(30, 93, 'Mortality Rate:'+profile_sectors.health.parameters[0].items[5].item_value);
			doc.text(110, 73, 'Contraceptive Prevalence Rate:'+profile_sectors.health.parameters[0].items[6].item_value);
			doc.text(110, 77, 'Malnutrition Rate - Pre School:'+profile_sectors.health.parameters[0].items[7].item_value);
			doc.text(139, 81, 'In-School:'+profile_sectors.health.parameters[0].items[8].item_value);
			doc.text(110, 89, 'Number of Hospitals:'+profile_sectors.health.parameters[0].items[9].item_value);
...
<<<<<<< HEAD
			...
			doc.text(50, 130, 'Index:'+profile_sectors.development.parameters[0].items[0].group_items[0].item_group_value);
			doc.text(100, 130, 'Non-Index:'+profile_sectors.development.parameters[0].items[0].group_items[1].item_group_value);
			doc.text(25, 134, 'Number of Cooperatives:'+profile_sectors.development.parameters[0].items[1].item_value);
			doc.text(25, 138, 'Number of Banks:'+profile_sectors.development.parameters[0].items[2].item_value);
			doc.text(25, 142, 'Number of Lending Institution:'+profile_sectors.development.parameters[0].items[3].item_value);
			doc.text(110, 134, 'Number of Messengerial Office:'+profile_sectors.development.parameters[0].items[4].item_value);
