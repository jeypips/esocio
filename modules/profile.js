angular.module('profile-module',['bootstrap-modal','bootstrap-growl','sector-data']).factory('form', function($compile,$timeout,$http,bootstrapModal,growl,sectors) {
	...
	function form() {
		...
		function print(scope,profile_sectors) {
			...
			["COMMODITY", "EMPLOYMENT GENERATED" , "INCOME GENERATED (PhP.)"];	
			...
			doc.text(70, 172, 'Concrete:'+profile_sectors.infra.parameters[1].items[0].group_items[1].item_group_value);
			...
			doc.text(70, 182, 'Concrete:'+profile_sectors.infra.parameters[1].items[1].group_items[1].item_group_value);
			...
			doc.text(70, 196, 'Concrete:'+profile_sectors.infra.parameters[1].items[2].group_items[1].item_group_value);
			...
			doc.text(70, 204, 'Concrete:'+profile_sectors.infra.parameters[1].items[3].group_items[1].item_group_value);
			...
			doc.text(70, 218, 'Concrete:'+profile_sectors.infra.parameters[1].items[4].group_items[1].item_group_value);
			...
			doc.text(70, 226, 'Concrete:'+profile_sectors.infra.parameters[1].items[5].group_items[1].item_group_value);
			...
			doc.text(70, 240, 'Concrete:'+profile_sectors.infra.parameters[1].items[6].group_items[1].item_group_value);
			...
			doc.text(70, 248, 'Concrete:'+profile_sectors.infra.parameters[1].items[7].group_items[1].item_group_value);
