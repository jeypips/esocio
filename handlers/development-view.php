...
if (count($profile_sector)) {
	$development = $sectorsObj->profileSector($_POST['profile_id'],$_POST['sector']);	
} else {
	$development = $sectorsObj->fetchSector($_POST['sector']);	
}

$response = array("development"=>$development);
